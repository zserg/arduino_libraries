...
bool RF24::write( const void* buf, uint8_t len )
{
  ...
  do
  {
    ...
    //status1 = read_register(CONFIG,&config,1);
    IF_SERIAL_DEBUG(Serial.print("TX:"));
    IF_SERIAL_DEBUG(Serial.print(observe_tx,HEX));
    IF_SERIAL_DEBUG(Serial.print("CFG:"));
    IF_SERIAL_DEBUG(Serial.print(config,HEX));
    IF_SERIAL_DEBUG(Serial.print("Status:"));
